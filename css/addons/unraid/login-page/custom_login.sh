...
if grep -q "data-tp='theme'" ${LOGIN_PAGE}; then
  ...
  printf "  --main-bg-color: black !important;\n" >> "${TMP_STYLE}"
  printf "  --body-before: #70d7f61a !important;\n" >> "${TMP_STYLE}"
  printf "  --body-after: none !important;\n" >> "${TMP_STYLE}"
  printf "  --body-animation: flicker !important;\n" >> "${TMP_STYLE}"
  printf "  --text-color: #70d7f6 !important;\n" >> "${TMP_STYLE}"
  printf "  --input-color: #70d7f6 !important;\n" >> "${TMP_STYLE}"
  printf "  --link-color: #70d7f6 !important;\n" >> "${TMP_STYLE}"
  printf "  --link-color-hover: #8f2809 !important;\n" >> "${TMP_STYLE}"
  printf "  --case-color: #70d7f6 !important;\n" >> "${TMP_STYLE}"
  printf "  --button-text-color: #70d7f6 !important;\n" >> "${TMP_STYLE}"
  printf "  --button-text-color-hover: #000 !important;\n" >> "${TMP_STYLE}"
  printf "  --button-color: #70d7f6 !important;\n" >> "${TMP_STYLE}"
  printf "  --button-color-hover: #8f2809 !important;\n" >> "${TMP_STYLE}"
  printf "  --selection-color: #8f2809 !important;\n" >> "${TMP_STYLE}"
  printf "  --custom-text-header: #70d7f6 !important;\n" >> "${TMP_STYLE}"
  printf "  --custom-text-header-shadow: #70d7f6 !important;\n" >> "${TMP_STYLE}"
  printf "  --custom-text-header-animation: textflicker !important;\n" >> "${TMP_STYLE}"
  printf "  --input-font: 'Share Tech Mono', monospace !important;\n" >> "${TMP_STYLE}"
  printf "  --text-font: 'Share Tech Mono', monospace !important;\n" >> "${TMP_STYLE}"
  printf "  --loginbox-background-color: transparent !important;\n" >> "${TMP_STYLE}"
  printf "  --text-shadow: 0 0 8px !important;\n" >> "${TMP_STYLE}"
  printf "  --text-shadow-color: #70d7f6 !important;\n" >> "${TMP_STYLE}"
  printf "  --box-shadow: 0 0 15px !important;\n" >> "${TMP_STYLE}"
  printf "}\n" >> "${TMP_STYLE}"
  printf "#login .logo {\n" >> "${TMP_STYLE}"
